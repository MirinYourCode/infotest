...
$connect = new PDO("mysql:host=localhost;dbname=`employer`", "root", "mysql");
...
if(isset($_POST["query"]))
{
    ...
    $query = "
	SELECT company_name FROM emplyer 
		WHERE company_name LIKE '%".$condition."%' 
		ORDER BY id DESC 
		LIMIT 10
	";
    ...
    {
        $data[] = array(
            'company_name'		=>	str_ireplace($condition, $replace_string, $row["company_name"])
        );
    }
